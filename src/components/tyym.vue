...
<div class="view">
    ...
    <div class="oarow">
      <el-row>
        ...
        <router-link to="/pkxt">排课系统-1</router-link>
        <router-link to="/gztj">排课系统-2</router-link>
        <router-link to="/zdpk">排课系统-3</router-link>
        <router-link to="/pktz">排课系统-4</router-link>
        <router-link to="/ckkb">排课系统-5</router-link>
      </el-row>
    </div>
...
"></i> <i class="el-icon-delete"></i>
    ...
    <div class="oaeditor" style="margin-top:50px;">
